MEMORY
{
  ...
  dram0_0_seg(RW): org = 0x3FFB0000 + 0xdb5c, len = 0x2c200 - 0xdb5c
...
ztest :
{
 ...
 bt_conn_cb_area : SUBALIGN(4) { _bt_conn_cb_list_start = .; KEEP(*(SORT_BY_NAME(._bt_conn_cb.static.*))); _bt_conn_cb_list_end = .; } > drom0_0_seg AT > ROM
