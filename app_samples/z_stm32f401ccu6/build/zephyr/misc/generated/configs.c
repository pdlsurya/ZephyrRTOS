...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 84000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF24_DRV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SD_DRV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SH1106_GFX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF24_BLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SD_FAT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BLACKPILL_F401CC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONSOLE_GETLINE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0x4440);
